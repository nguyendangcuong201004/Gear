...
<body>
    ...
    <script>
        ...
        function viewContact(id) {
            ...
            const url = '/Gear/ContactAdmin/viewContactDetails/' + id;
        ...
        function sendReply(contactId) {
            ...
            fetch('/Gear/ContactAdmin/replyToContact', {
                method: 'POST',
                body: formData
            })
            .then(response => {
        ...
        function changeStatus(id, status) {
            ...
            fetch('/Gear/ContactAdmin/changeContactStatus', {
                method: 'POST',
                body: formData
            })
            .then(response => {
        ...
        function deleteContact(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch('/Gear/ContactAdmin/deleteContact', {
                        method: 'POST',
                        body: formData
                    })
                    .then(response => {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            Swal.fire({
                                title: 'Lỗi!',
                                text: data.message || 'Không thể xóa liên hệ.',
                                icon: 'error'
                            });
                        }
                    })
