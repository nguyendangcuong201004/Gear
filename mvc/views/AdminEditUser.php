...
<head>
    ...
    <link rel="stylesheet" href="/public/css/adminUserEdit.css">
</head>
<body>
    <div class="header">
        <h1>ADMIN</h1>
        <div class="buttons">
            <button class="source-btn" onclick="location.href='/AdminUserController/list'">Quay về</button>
    ...
    <div class="main-container">
        ...
        <div class="content">
            ...
            <div class="user-edit-details">
                <form method="POST" action="/AdminUserController/update/<?= $user['id'] ?? '' ?>">
                    ...
                    <div class="form-actions">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="location.href='/AdminUserController/list'">Quay lại</button>
                    </div>
                </form>
            </div>
        </div>
