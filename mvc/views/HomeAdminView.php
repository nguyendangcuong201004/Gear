                ...
                <div class="tab-content" id="adminTabContent">
                    ...
                    <div class="tab-pane fade show active" id="general-content" role="tabpanel" aria-labelledby="general-tab">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="/Gear/HomeAdmin/updateSettings" method="POST" enctype="multipart/form-data" class="ajax-form">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="mt-2">
                                                <img src="public/images/<?php echo htmlspecialchars($data['settings']['logo']); ?>" alt="Current Logo" class="img-thumbnail img-preview" style="max-height: 100px;">
                                            </div>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="public/images/<?php echo htmlspecialchars($slide['image_url']); ?>" 
                            ...
                            <div class="card-body">
                                <form action="/Gear/HomeAdmin/updateSettings" method="POST" enctype="multipart/form-data" class="ajax-form">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2">
                                            <img src="public/images/<?php echo htmlspecialchars($data['settings']['about_image']); ?>" alt="About Image" class="img-thumbnail img-preview" style="max-height: 200px;">
                                        </div>
                                        <?php endif; ?>
                                    </div>
    ...
    <div class="modal fade" id="addSlideModal" tabindex="-1" aria-labelledby="addSlideModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <form action="/Gear/HomeAdmin/addCarouselSlide" method="POST" enctype="multipart/form-data" class="ajax-form">
    ...
    <div class="modal fade" id="editSlideModal" tabindex="-1" aria-labelledby="editSlideModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <form action="/Gear/HomeAdmin/updateCarouselSlide" method="POST" enctype="multipart/form-data" class="ajax-form">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer flex-wrap gap-2">
                    ...
                    <form action="/Gear/HomeAdmin/deleteCarouselSlide" method="POST" class="ajax-form">
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (response.trim().startsWith('{')) {
                                ...
                                // Don't reload the page, just refresh the content
                                const currentTab = localStorage.getItem('activeAdminTab');
                                if(currentTab) {
                                    setTimeout(function() {
                                        location.href = location.pathname + (currentTab.startsWith('#') ? currentTab : '');
                                    }, 2000);
                                } else {
                                    setTimeout(function() {
                                        location.reload();
                        ...
                        if (successStatus) {
                            ...
                            if (form.closest('.modal').length) {
                                ...
                                // Reload the page after a short delay to refresh the content
                                setTimeout(function() {
                                    location.reload();
                                }, 2000);
                            }
