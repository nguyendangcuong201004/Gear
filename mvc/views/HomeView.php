...
<body class="bg-light">
                ...
                <div class="col-12">
                    <div class="inner-content">
                        ...
                        <a class="inner-logo text-decoration-none text-dark" href="">
                            <img src="public/images/<?php echo htmlspecialchars($data['settings']['logo']); ?>" alt="GearBK Logo">
    ...
    <div class="container-fluid pt-3">
        <div class="row g-3">
            <!-- Mobile Categories Dropdown (visible on small screens) -->
            ...
            <!-- Desktop Categories Sidebar (hidden on small screens) -->
                        ...
                        ?>
                            <div class="carousel-item <?php echo ($index === 0) ? 'active' : ''; ?>">
                                ...
                                <div class="carousel-caption d-flex align-items-end justify-content-center pb-5" 
                                    style="top: 0; left: 0; right: 0; bottom: 0; width: 100%; height: 500px; position: absolute; background: linear-gradient(to top, rgba(0,0,0,1), rgba(0,0,0,0) 50%);">
                                    <div>
    ...
    <div class="container pt-4 pt-md-5">
        ...
        <div class="position-relative d-none d-md-block">
            <div class="navigation-buttons position-absolute top-50 start-0 translate-middle-y">
            ...
            <div class="navigation-buttons position-absolute top-50 end-0 translate-middle-y">
                        ...
                        <?php if (isset($data['settings']['about_content']) && !empty($data['settings']['about_content'])): ?>
                            <div class="row g-0">
                                ...
                                <div class="col-md-5 position-relative">
                                    <div class="h-100" style="background: linear-gradient(rgba(220, 53, 69, 0.8), rgba(220, 53, 69, 0.4)), url('public/images/<?php echo htmlspecialchars($data['settings']['about_image']); ?>'); background-size: cover; background-position: center; min-height: 200px; @media (min-width: 768px) { min-height: 300px; }"></div>
