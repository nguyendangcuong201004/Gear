...
class QAAdminController {
    ...
    public function editQuestion($id) {
        ...
        if (!$question) {
            header('Location: /Gear/QAAdminController/dashboard');
            exit;
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($success) {
                header('Location: /Gear/QAAdminController/dashboard?message=Question+updated+successfully');
                exit;
            } else {
    ...
    public function editAnswer($id) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($success) {
                header('Location: /Gear/QAAdminController/dashboard?tab=answers&message=Answer+updated+successfully');
                exit;
            } else {
    ...
    public function deleteQuestion() {
        ...
        if ($success) {
            header('Location: /Gear/QAAdminController/dashboard?message=Question+deleted+successfully');
        } else {
            header('Location: /Gear/QAAdminController/dashboard?message=Error+deleting+question&message_type=error');
        }
        exit;
    }
    ...
    public function deleteAnswer() {
        ...
        if ($success) {
            header('Location: /Gear/QAAdminController/dashboard?tab=answers&message=Answer+deleted+successfully');
        } else {
            header('Location: /Gear/QAAdminController/dashboard?tab=answers&message=Error+deleting+answer&message_type=error');
        }
        exit;
    }
    ...
    public function manageTag() {
        ...
        // Kiểm tra method
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: /Gear/QAAdminController/dashboard?tab=tags');
            exit;
        }
        ...
        if ($success) {
            header('Location: /Gear/QAAdminController/dashboard?tab=tags&message=Tag+operation+completed+successfully');
        } else {
            header('Location: /Gear/QAAdminController/dashboard?tab=tags&message=Error+during+tag+operation&message_type=error');
        }
        exit;
    }
} 