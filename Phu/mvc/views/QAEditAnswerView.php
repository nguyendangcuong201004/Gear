    ...
    <div class="container admin-container">
        ...
        <div class="admin-card animate__animated animate__fadeIn">
            ...
            <div class="question-info">
                ...
                <p class="mb-1"><strong>Title:</strong> <a href="/ltw/QAController/detail/<?= $answer['question_id'] ?>" target="_blank"><?= htmlspecialchars($answer['question_title'] ?? '') ?></a></p>
            ...
            <form method="post" action="">
                ...
                <div class="form-group text-center">
                    <a href="/ltw/QAAdminController/dashboard?tab=answers" class="btn btn-secondary mr-2">
