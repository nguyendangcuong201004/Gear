    ...
    <div class="qa-container">
            ...
            <div class="qa-buttons animate__animated animate__fadeIn animate__delay-1s">
                <?php if (isset($_COOKIE['access_token'])): ?>
                    <?php if (!isset($data['is_my_questions'])): ?>
                        <a href="/ltw/QAController/myQuestions" class="qa-btn qa-btn-secondary mr-2">
                            <i class="fas fa-list"></i> My Questions
                        </a>
                    <?php else: ?>
                        <a href="/ltw/QAController/list" class="qa-btn qa-btn-secondary mr-2">
                ...
                <?php else: ?>
                    <a href="/ltw/AuthController/login" class="qa-ask-btn">
                        <i class="fas fa-plus-circle"></i> Ask a Question
                    </a>
                <?php endif; ?>
            </div>
        ...
        <?php if (!isset($data['is_my_questions'])): ?>
            <div class="qa-search-container animate__animated animate__fadeIn animate__delay-1s">
                <form method="get" action="/ltw/QAController/search" class="qa-search-container">
                    <input 
                        type="text" 
                        name="keyword"           
                        id="search-input" 
            ...
            <?php while ($question = mysqli_fetch_assoc($data["questions"])): ?>
                <div class="qa-card">
                    <div class="qa-card-body">
                        ...
                        <a href="/ltw/QAController/detail/<?= $question['id']; ?>" class="text-decoration-none">
        ...
        <?php else: ?>
            <div class="qa-empty animate__animated animate__fadeIn">
                ...
                <?php endif; ?>
                <a href="/ltw/QAController/create" class="qa-ask-btn pulse-animation">
                    <i class="fas fa-plus-circle"></i> Ask a Question
                </a>
            </div>
        <?php endif; ?>
                ...
                <nav aria-label="Question navigation">
                    <ul class="pagination justify-content-center">
                        ...
                        <li class="page-item <?= $data["page"] <= 1 ? 'disabled' : ''; ?>">
                            <a class="page-link" href="/ltw/QAController/page/<?= $data["page"] - 1; ?>" aria-label="Previous">
                        ...
                        <?php for ($i = 1; $i <= $data["total_pages"]; $i++): ?>
                            <li class="page-item <?= $i == $data["page"] ? 'active' : ''; ?>">
                                <a class="page-link" href="/ltw/QAController/page/<?= $i; ?>"><?= $i; ?></a>
                            </li>
                        <?php endfor; ?>

                        <!-- Next -->
                        <li class="page-item <?= $data["page"] >= $data["total_pages"] ? 'disabled' : ''; ?>">
                            <a class="page-link" href="/ltw/QAController/page/<?= $data["page"] + 1; ?>" aria-label="Next">
                                <span aria-hidden="true">»</span>
                            </a>
                        </li>
                    </ul>
