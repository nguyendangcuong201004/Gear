...
<head>
    ...
    <style>
        body {
            ...
            background: url('/ltw/public/images/background_login.webp') no-repeat center center fixed;
            ...
            <div class="col-md-3">
                <div class="admin-card">
                    ...
                    <div class="text-center">
                        <a href="/ltw/QAController/list" class="btn btn-purple btn-sm">
                    ...
                    <div class="tab-pane fade <?= $active_tab === 'questions' ? 'show active' : '' ?>" id="questions" role="tabpanel">
                        <div class="admin-card">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="/ltw/QAController/create" class="btn btn-purple">
                                        ...
                                        <?php if (!empty($questions)): ?>
                                            <?php while ($question = mysqli_fetch_assoc($questions)): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/ltw/QAController/detail/<?= $question['id'] ?>" class="btn btn-sm btn-info" title="View">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a href="/ltw/QAAdminController/editQuestion/<?= $question['id'] ?>" class="btn btn-sm btn-primary" title="Edit">
                                ...
                                <nav aria-label="Questions pagination">
                                    <ul class="pagination justify-content-center mt-4">
                                        <li class="page-item <?= $page <= 1 ? 'disabled' : '' ?>">
                                            <a class="page-link" href="/ltw/QAAdminController/dashboard?page=<?= $page - 1 ?>&tab=questions">Previous</a>
                                        </li>
                                        
                                        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                                            <li class="page-item <?= $page == $i ? 'active' : '' ?>">
                                                <a class="page-link" href="/ltw/QAAdminController/dashboard?page=<?= $i ?>&tab=questions"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        
                                        <li class="page-item <?= $page >= $total_pages ? 'disabled' : '' ?>">
                                            <a class="page-link" href="/ltw/QAAdminController/dashboard?page=<?= $page + 1 ?>&tab=questions">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            <?php endif; ?>
                                        ...
                                        <?php if (!empty($answers)): ?>
                                            <?php while ($answer = mysqli_fetch_assoc($answers)): ?>
                                                <tr>
                                                    <td><?= $answer['id'] ?></td>
                                                    <td>
                                                        <a href="/ltw/QAController/detail/<?= $answer['question_id'] ?>" title="View Question">
                                                            #<?= $answer['question_id'] ?>
                                                        </a>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <a href="/ltw/QAAdminController/editAnswer/<?= $answer['id'] ?>" class="btn btn-sm btn-primary" title="Edit">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                ...
                                <nav aria-label="Answers pagination">
                                    <ul class="pagination justify-content-center mt-4">
                                        <li class="page-item <?= $data['answers_page'] <= 1 ? 'disabled' : '' ?>">
                                            <a class="page-link" href="/ltw/QAAdminController/dashboard?answers_page=<?= $data['answers_page'] - 1 ?>&tab=answers">Previous</a>
                                        </li>
                                        
                                        <?php for ($i = 1; $i <= $data['answers_total_pages']; $i++): ?>
                                            <li class="page-item <?= $data['answers_page'] == $i ? 'active' : '' ?>">
                                                <a class="page-link" href="/ltw/QAAdminController/dashboard?answers_page=<?= $i ?>&tab=answers"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        
                                        <li class="page-item <?= $data['answers_page'] >= $data['answers_total_pages'] ? 'disabled' : '' ?>">
                                            <a class="page-link" href="/ltw/QAAdminController/dashboard?answers_page=<?= $data['answers_page'] + 1 ?>&tab=answers">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            <?php endif; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteQuestionForm" action="/ltw/QAAdminController/deleteQuestion" method="post">
    ...
    <div class="modal fade" id="deleteAnswerModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <form id="deleteAnswerForm" action="/ltw/QAAdminController/deleteAnswer" method="post">
    ...
    <div class="modal fade" id="tagModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="tagForm" action="/ltw/QAAdminController/manageTag" method="post">
                    <div class="modal-body">
        ...
        $(document).ready(function() {
            ...
            $('.delete-tag').click(function() {
                if (confirm('Are you sure you want to delete this tag?')) {
                    ...
                    $.post('/ltw/QAAdminController/manageTag', {
                        tag_id: tagId,
                        action: 'delete'
