...
<head>
    ...
    <link rel="stylesheet" href="/ltw/public/css/blog2.css">
...
<body>
    ...
    <section class="blog-posts">
        <?php if ($data["posts"] && mysqli_num_rows($data["posts"]) > 0): ?>
            <?php while ($row = mysqli_fetch_assoc($data["posts"])): ?>
                <a href="/ltw/BlogController/detail/<?= $row['id']; ?>" class="blog-post">
                    <div class="blog-post">
    ...
    <script>
        function handleSearch(event) {
            ...
            if (keyword) {
                window.location.href = "/ltw/BlogController/search/" + keyword;
            } else {
                window.location.href = "/ltw/BlogController/list";
            }
        }
