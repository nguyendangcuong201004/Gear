...
class QAController {
    ...
    public function edit($id) {
        ...
        if ($question->num_rows == 0) {
            header('Location: /ltw/QAController/admin');
            exit;
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($success) {
                header('Location: /ltw/QAController/admin?message=Question+updated+successfully');
                exit;
            } else {
    ...
    public function editAnswer($id) {
        ...
        if (!$answer) {
            header('Location: /ltw/QAController/admin?tab=answers');
            exit;
        }
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($success) {
                header('Location: /ltw/QAController/admin?tab=answers&message=Answer+updated+successfully');
                exit;
            } else {
    ...
    public function deleteQuestion() {
        ...
        if ($success) {
            header('Location: /ltw/QAController/admin?message=Question+deleted+successfully');
        } else {
            header('Location: /ltw/QAController/admin?message=Error+deleting+question&message_type=error');
        }
        exit;
    }
    ...
    public function deleteAnswer() {
        ...
        if ($success) {
            header('Location: /ltw/QAController/admin?tab=answers&message=Answer+deleted+successfully');
        } else {
            header('Location: /ltw/QAController/admin?tab=answers&message=Error+deleting+answer&message_type=error');
        }
        exit;
    }
    ...
    public function manageTag() {
        ...
        // Kiểm tra method
        if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
            header('Location: /ltw/QAController/admin?tab=tags');
            exit;
        }
        ...
        if ($success) {
            header('Location: /ltw/QAController/admin?tab=tags&message=Tag+updated+successfully');
        } else {
            header('Location: /ltw/QAController/admin?tab=tags&message=Error+updating+tag&message_type=error');
        }
        exit;
    }
